...
def create_inverse_solution(epochs, forward, epoch_num = 0, covariance_method = ['empirical', 'shrunk'],
	loose = 0.2, depth = 0.8, snr = 3.0, inverse_epochs_method = "dSPM",
	pick_ori = 'normal'):
	"""
...
def plot_topomap_3d_brain(epochs, stc = 'auto', display_time = None, views = ['lateral', 'dorsal','coronal', 'frontal'],
	...
	transparent = False, alpha = 1.0, cortex = 'classic', background = 'black', foreground = 'white',
	spacing = 'oct6', smoothing_steps = 10):
	"""
	...
	brain = stc.plot(views= views,
	                 ...
	                 size = auto_plot_size,
	                 subject= None,
	                 initial_time = display_time, # For selecting image of individual frame.
	                 clim = clim_values,
...
def save_animated_topomap_3d_brain(brain, filename, time_dilation = 20, interpolation = 'linear', 
	framerate = 12, time_viewer = True):
	"""
