...
\newpage
```{python example-table, include=FALSE}
...
table = knitr::kable(
  py$table,
  caption = "First Ten Rows of Example Source Data for Experiment 927",
  digits = 4,
  format = "latex"
)
...
![Timeline and Milestones](images/TimelineGanttChart.pdf)
