...
![Raw voltage plot](images/raw_voltage.png){ height=20% width=75%}

2) 2D topographic head map - visualize a topographic heatmap of the voltage values mapped to a 2D model of a skull
...
![3D topographic brain map](images/3d_brain.png){ height=20% }

5) Connectivity plot - visualize pairwise connectivity measurements between nodes for specified time ranges
...
Multiple visualization techniques were included in order to allow the data to be viewed from different perspectives. Each visualization type comes with its own advantages and drawbacks, detailed in the table below. 
